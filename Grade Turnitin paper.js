...
javascript:(()=>{  let bodyText = document.querySelector('#body').innerText

  // Step 2: Normalize the text
  const normalizedText = bodyText.toLocaleLowerCase()
  
  // Step 3: Define your keywords
  const keywords = ['celebrate', 'commemorate', 'question', 'questions', 'air force association', 'legion', 'veterans', 'tibbets', 'dole', 'gingrich', 'limbaugh', 'culture', 'vietnam', 'right', 'left', 'gay', 'gays', 'historians', 'revision', 'correct', 'fragmented', 'identity', 'destablize', 'myth', 'origin', 'development', 'doubt', 'uncertainty', 'world war' ]
